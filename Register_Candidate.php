...
<form  method="post" action="http://localhost/OVS/Register_Candidate.php">
<table>
<th>
Register Candidate
</th>
...
{
if($r['usn']==$usn){
if(mysql_query("insert into candidate values('$usn',$nov)"))
...
if($flag==0)
{
	echo "Invalid Candidate, He is not yet Registered";
}
?>
